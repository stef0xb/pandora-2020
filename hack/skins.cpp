...
void Skins::load( ) {
	...
	/*m_knife_data[knives_t::DEFAULT_CT].setup(KNIFE_CT,
		XOR("models/weapons/v_knife_default_ct.mdl"),
		XOR("models/weapons/w_knife_default_ct.mdl"),
		XOR("knife_default_ct"));

	m_knife_data[knives_t::DEFAULT_T].setup(KNIFE_T,
		XOR("models/weapons/v_knife_default_t.mdl"),
		XOR("models/weapons/w_knife_default_t.mdl"),
		XOR("knife_t"));*/
...
{
	static auto fn = pattern::find( g_csgo.m_client_dll, XOR( "55 8B EC 51 53 56 8B 75 08 8B D9 57 6B FE 2C" ) ).as< std::int32_t( __thiscall* )( void*, std::int32_t )>( );
	if( !fn )
		return;
